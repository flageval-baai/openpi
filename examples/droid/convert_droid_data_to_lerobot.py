...
REPO_NAME = "test_robochallenge"  # Name of the output dataset, also used for the Hugging Face Hub
...
def main(data_dir: str, *, push_to_hub: bool = False):
    ...
    output_path = Path('/share/project/embodied/realbench/data/converted_data') / REPO_NAME
    ...
    dataset = LeRobotDataset.create(
        ...
        features={
            ...
            "prompt": {"dtype": "string",
                       "shape":(1,)}
            # Note: Do NOT declare 'task' in features.
            # 'task' is provided per-frame when calling add_frame and is
            # handled specially by LeRobot (it is converted to 'task_index').
        },
